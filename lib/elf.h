...
#ifdef _WIN32
  #error "You should not be compiling on Windows! The Win32 Compilation system for this bootloader contains dummy files for Intellisense, but should not be use to compile! Use WSL instead."
#else
  #include <features.h>
#endif
